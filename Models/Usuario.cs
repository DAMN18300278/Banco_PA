...
public partial class Usuario
{
    ...
    [StringLength(200)]
    [RegularExpression(@"^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$", ErrorMessage = "Ingrese un nombre valido por favor")]
    public string NombreS { get; set; } = null!;
    [StringLength(30)]
    [RegularExpression(@"^[a-zA-ZáéíóúÁÉÍÓÚñÑ]+$", ErrorMessage = "Ingrese un apellido valido por favor")]
